...
| llama10rep_final1 | Average Llama cooperation over 10 iterations using double extraction, logical steps and logical verifier|
| llama10rep_final2 | Average Llama cooperation over 10 iterations using double extraction, logical steps and logical verifier|
| matrix_human| Average human cooperation provided by the original experiment Poncela-Casasnovas et al. (2016)|
...
| mistral10rep_final1 | Average Mistral cooperation over 10 iterations using double extraction, logical steps and logical verifier|
| mistral10rep_final2 | Average Mistral cooperation over 10 iterations using double extraction, logical steps and logical verifier|
| nash.txt | Nash cooperation|
...
| qwen10rep_final1 | Average Qwen cooperation over 10 iterations using double extraction, logical steps and logical verifier|
| qwen10rep_final2 | Average Qwen cooperation over 10 iterations using double extraction, logical steps and logical verifier|
